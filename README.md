...
当前翻译的 Phabricator 版本：(stable) Promote 2017 Week 27 [[eed68de](https://secure.phabricator.com/rPeed68de99984e77e06258f0095eb86c6179f7e65)]，文件 `i18n_files.json` 的 SHA1 值：489a5c96b4f769bc04f535fdd5c27e5178885607。

当前总词条数量：14494 条，不包含原型应用的总词条数量：12270 条。

当前整体翻译进度百分比：46%。

当前短词条翻译进度百分比：53%。注：短词条为长度小于 66 个字符的词条。
...
applications/harbormaster | 38% | === | 34% | ===
